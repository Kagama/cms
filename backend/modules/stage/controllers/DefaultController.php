...
namespace backend\modules\stage\controllers;

use Yii;
use common\modules\stage\models\Stage;
use common\modules\stage\models\search\StageSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * DefaultController implements the CRUD actions for Stage model.
 */
